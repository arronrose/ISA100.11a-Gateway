...
class ResourceException : public NE::Common::NEException{
    public:
    	ResourceException(const std::string& message) : NE::Common::NEException(message){}
};

class DeviceValueLimitedException : public NE::Common::NEException{
    public:
    	DeviceValueLimitedException(const std::string& message) : NE::Common::NEException(message){}
};
