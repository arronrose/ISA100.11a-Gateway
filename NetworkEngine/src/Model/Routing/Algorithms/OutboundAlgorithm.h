...
#ifndef OUTBOUNDALGORITHM_H_
#define OUTBOUNDALGORITHM_H_
...
class OutboundAlgorithm : public NE::Model::Routing::GraphRoutingAlgorithmInterface {
    LOG_DEF("I.M.R.A.OutboundAlgorithm");
    public:
        ...
        void reverseEdge( Subnet::PTR subnet, OutboundGraphMap &outboundGraph,
    ...
    private:
        std::map<Address16, Int16> nodeCost;
};
}
}
}
