 ...
 */
#ifndef READLISTENER_H_
#define READLISTENER_H_

#include "Common/Objects/ReadRequest.h"
#include "Common/Objects/ReadResponse.h"
...
class ReadListener;
typedef boost::shared_ptr<ReadListener> ReadListenerPointer;

class ReadListener {
        ObjectIDEnum idListener;

    public:
        ReadListener(ObjectIDEnum idListener) {
        ...
        void indication(ServicePriority::ServicePriority priority, TransmissionTime endToEndTransmissionTime,
                    ...
                    TLDE_SAP_Number clientTLDE_SAP, const ReadRequest& readRequest);
        ...
        void confirmation(ServicePriority::ServicePriority priority, TransmissionTime endToEndTransmissionTime,
                    ...
                    TLDE_SAP_Number clientTLDE_SAP, const ReadResponse& readResponse);
};
