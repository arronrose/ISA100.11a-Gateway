...
///////////////////////////////////////////////////////////////////////////////
uint16_t Ccm2::AuthEncrypt( const uint8_t * p_key, const uint8_t * p_nonce
		    ...
		    , uint8_t * p_out)
{
	...
	m_iKeyNr = rijndaelKeySetupEnc((u32*) m_rguiKeyRk, m_puiKey, AES_ENCRYPT_BITS ) ;
...
//
///////////////////////////////////////////////////////////////////////////////
bool Ccm2::CheckAuthDecrypt( const uint8_t* p_key, const uint8_t* p_nonce,
				uint8_t* p_aad, uint16_t p_aadSz,
...
///////////////////////////////////////////////////////////////////////////////
void Ccm2::pushBlock0( uint16_t p_aadSz, uint16_t p_msgSz )
{
	m_uiWorkBufIdx = 0 ;
	/// Push Flags
...
///////////////////////////////////////////////////////////////////////////////
void Ccm2::pushAad( const uint8_t* p_aad, uint16_t p_aadSz )
{
	if ( !p_aadSz ) return ;
...
///////////////////////////////////////////////////////////////////////////////
void Ccm2::pushMsg( const uint8_t* p_msg, uint16_t p_msgSz )
{
	if ( !p_msgSz ) return ;
...
void Ccm2::cbcMac(void)
{
	...
	rijndaelEncrypt( (u32*)m_rguiKeyRk, m_iKeyNr, m_prguiWorkBuf, X_1 ) ;
	...
	for ( ; blk_it < m_uiWorkBufSz ; blk_it+=AES_BLOCK_SZ )
	{
		...
		rijndaelEncrypt( (u32*)m_rguiKeyRk, m_iKeyNr, X_1, X_n ) ;
...
///////////////////////////////////////////////////////////////////////////////
void Ccm2::saltCtr( const uint8_t* p_msg, uint16_t p_msgSz )
{
	...
	rijndaelEncrypt( (u32*)m_rguiKeyRk, m_iKeyNr, A, S ) ;
