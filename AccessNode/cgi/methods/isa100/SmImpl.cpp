...
{	size_t nChr = 0;
	...
	for( int i = 0; p_szSrc[i] && (p_szSrc[i] != ',') && (p_szSrc[i] != '-') && (nChr < (p_dwSize-1)); ++i )	/// stop parsing at comma
...
static bool sExtractEUI64Specifier( const char * p_szSrc, size_t p_dwSize, char * p_pDst)
{
	...
	const char * pDash  = strchr(p_szSrc, '-');
...
////////////////////////////////////////////////////////////////////////////////
/// @author Marcel Ionescu
/// @brief format EUI64 as XXXX:XXXX:XXXX:XXXX
...
////////////////////////////////////////////////////////////////////////////////
/// @author Marcel Ionescu
/// @brief format EUI64Specifier as either XXXX:XXXX:XXXX:XXXX (if input is single EUI64) or
/// @brief XXXX:XXXX:XXXX:XXXX - XXXX:XXXX:XXXX:XXXX (if input is EUI64 pair dash-separated)
/// @param p_pEUI64Specifier input string, unformatted 16 bytes (hex-representation) or pair of 16 bytes separated by dash
/// @param p_pBuffer buffer to receive formatted string.
/// @note TAKE CARE p_pBuffer must have allocated at least 19+19+3+1=42 bytes
////////////////////////////////////////////////////////////////////////////////
static const char * sFormatEUI64Specifier( const char * p_pEUI64Specifier, char *p_pBuffer )
{	const char * pDash  = strchr(p_pEUI64Specifier, '-');
...
///	@remarks <EUI64> formatted XXXX:XXXX:XXXX:XXXX
...
////////////////////////////////////////////////////////////////////////////////
bool SmImpl::setDevice( const char * p_szDevice, const char * p_szDeviceType )
{	CConfigImpl oConfig;
	char szFormattedRow[ 1024 ];
	if( !sFormatDevice(p_szDevice, szFormattedRow, sizeof(szFormattedRow) ))
		return false;
	return oConfig.setConfigRow( CONF_SM_WHITELIST, "SECURITY_MANAGER", p_szDeviceType, szFormattedRow, &sExtractEUI64Specifier, EUI64_PAIR_SIZE );
}
...
/// @remarks primary key is <EUI64Specifier>
////////////////////////////////////////////////////////////////////////////////
bool SmImpl::delDevice( const char * p_szDevice, const char * p_szDeviceType )
{
	CConfigImpl oConfig;
	return oConfig.delConfigRow( CONF_SM_WHITELIST, "SECURITY_MANAGER", p_szDeviceType, p_szDevice, &sExtractEUI64Specifier, EUI64_PAIR_SIZE );
}
