...
#ifndef GCLNTSERVERC_H_
#define GCLNTSERVERC_H_
...
class GClientServer_C : public AbstractGService
{
public:
...
public:
	...
	std::basic_string<boost::uint8_t>	m_transacInfo;;	// req

	std::basic_string<boost::uint8_t>	m_respData;		//resp
