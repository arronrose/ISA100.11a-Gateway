...
public:
	...
	bool RecvFrom(	void *msg, size_t* p_nLen, int flags,
					char *p_szIpFrom, int* p_pPortFrom = NULL  );
	bool RecvFrom(  void *msg, size_t* p_nLen, int flags = 0,
					u_int *p_pnIpFrom = NULL, int* p_pPortFrom = NULL );

	bool RecvFrom6(  void *msg, size_t* p_nLen, int flags = 0, char *p_szIPv6 = NULL, int* p_pPortFrom = NULL );
	bool SendTo6 (const char* p_szTo, int p_nPort, const void *msg, size_t len, int flags = 0);
