...
function PopulateFirmwareTypeList() {
    ...
    ddlFirmwareTpes.options[0] = new Option(GetFirmwareTypeName(FT_Device), FT_Device);
    ddlFirmwareTpes.options[1] = new Option(GetFirmwareTypeName(FT_AquisitionBoard), FT_AquisitionBoard);
    ddlFirmwareTpes.options[2] = new Option(GetFirmwareTypeName(FT_BackboneRouter), FT_BackboneRouter);    
}
